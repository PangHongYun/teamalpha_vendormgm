...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
	<body>
		...
		<div class="col-xs-4" >
		<div class="well">
        <form:form id="createEmp" method="post" action="createEmp"  modelAttribute="employee">
		<!-- company name -->			
		<div class="form-group">
        	<div class="form-group">
				<label for="companyName" class="control-label">Company Name </label><span class="mandatory">*</span>
				<form:input path="company_name" name="companyName" id="companyName" cssClass="form-control" required="required"/>
		</div>
		<!-- Employee Name -->
		<div class="form-group">
			<label for="empName" class="control-label">Name </label><span class="mandatory">*</span>
			<form:input path="employeeName" name="empName" id="empName" cssClass="form-control" required="required"/>
		</div>
		<!-- Employee Email -->
		<div class="form-group">
			<label for="empName" class="control-label">Email </label><span class="mandatory">*</span>
			<form:input path="employeeEmail"  id="employeeEmail"  cssClass="form-control" required="required" disabled="disabled" />
		</div>
		<!-- employee contact number -->			
		<div class="form-group">
        	<label for="companyContactNo" class="control-label">Contact Number (Office) </label><span class="mandatory">*</span>
            <form:input path="employeeContactNumber" name="empContactNo" id="empContactNo" cssClass="form-control" required="required"/>
		</div>
		<!-- employee department -->
		<div class="form-group">
			<label for="companyName" class="control-label">Department </label><span class="mandatory">*</span>
			<form:input path="employeeDepartment" name="empDept" id="empDept" cssClass="form-control" required="required"/>
		</div>
