...
<%
	List<VendorApp> applications = (List<VendorApp>)session.getAttribute("applications");
%>
<link rel="stylesheet"
					...
					<table class="table table-hover">
						...
						<tbody id="vendorsList">
							<c:forEach var="application" items="${applications}">
								<tr>
									<td>${application.projId}</td>
									<td>${application.vendorId}</td>
									<td><button>Vendor Details</button></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
